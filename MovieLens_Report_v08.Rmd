...
```{r load a smaller data set, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
###########################################################################
...
# this is a link to edx_1000k.dat file placed on my OneDrive public folder
# "https://1drv.ms/u/s!AvUHuDRMH7R4hbF1wN2eh34wraHISw"
# 
# I also had it in a local subfolder ml-10M100k/edx_1000k.dat
# movielens <- read_csv("ml-10M100k/edx_1000k.dat", col_names = TRUE, n_max = 500000)

set.seed(1)

# dowload edx_1000k.dat from one drive and select 500000 records
download.file("https://1drv.ms/u/s!AvUHuDRMH7R4hbF1wN2eh34wraHISw", "./edx_100k_02.dat")
movielens <- read_csv("https://1drv.ms/u/s!AvUHuDRMH7R4hbF1wN2eh34wraHISw", col_names = TRUE, n_max = 100000)
test_index <- createDataPartition(y = movielens$rating, times = 1, p = 0.1, list = FALSE)
